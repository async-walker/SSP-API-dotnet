...
namespace SSP_API.Types.Xsd
{
    ...
    public enum IdentityDocumentType
    {
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Паспорт гражданина РФ")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Паспорт гражданина РФ, удостоверяющий его личность за пределами территории РФ")]
        [System.ComponentModel.DescriptionAttribute("Паспорт гражданина Российской Федерации, удостоверяющий его личность за пределами территории Российской Федерации")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Дипломатический паспорт, удостоверяющий личность гражданина РФ за пределами территории РФ")]
        [System.ComponentModel.DescriptionAttribute("Дипломатический паспорт, удостоверяющий личность гражданина Российской Федерации за пределами территории Российской Федерации")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Служебный паспорт, удостоверяющий личность гражданина РФ за пределами территории РФ")]
        [System.ComponentModel.DescriptionAttribute("Служебный паспорт, удостоверяющий личность гражданина Российской Федерации за пределами территории Российской Федерации")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Удостоверение личности моряка")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Удостоверение личности военнослужащего")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Военный билет военнослужащего")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Временное удостоверение личности гражданина РФ, выдаваемое на период оформления паспорта гражданина РФ")]
        [System.ComponentModel.DescriptionAttribute("Временное удостоверение личности гражданина РФ, выдаваемое на период оформления паспорта гражданина РФ")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Свидетельство о рождении гражданина РФ")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Иной документ, удостоверяющий личность гражданина РФ в соответствии с законодательством РФ")]
        [System.ComponentModel.DescriptionAttribute("Иной документ, удостоверяющий личность гражданина Российской Федерации в соответствии с законодательством Российской Федерации")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Паспорт иностранного гражданина либо иной документ, установленный федеральным законом или признаваемый в соответствии с международным договором РФ в качестве документа, удостоверяющего личность иностранного гражданина")]
        [System.ComponentModel.DescriptionAttribute("Паспорт иностранного гражданина либо иной документ, установленный федеральным законом или признаваемый в соответствии с международным договором Российской Федерации в качестве документа, удостоверяющего личность иностранного гражданина")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Документ, выданный иностранным государством и признаваемый в соответствии с международным договором РФ в качестве документа, удостоверяющего личность лица без гражданства")]
        [System.ComponentModel.DescriptionAttribute("Документ, выданный иностранным государством и признаваемый в соответствии с международным договором РФ в качестве документа, удостоверяющего личность лица без гражданства")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Иной документ, признаваемый документом, удостоверяющим личность лица без гражданства в соответствии с законодательством РФ и международным договором РФ")]
        [System.ComponentModel.DescriptionAttribute("Иной документ, признаваемый документом, удостоверяющим личность лица без гражданства в соответствии с законодательством РФ и международным договором РФ")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Удостоверение беженца")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Удостоверение вынужденного переселенца")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Иной документ")]
    ...
    public partial class IdentityDocument
    {
        ...
        /// <param name="codeIdentityDocument"></param>
        public IdentityDocument(
            string series, 
            string number, 
            DateTime dateIssue, 
            string citizen, 
            IdentityDocumentType codeIdentityDocument)
        {
            Series = series;
            Number = number;
            DateIssue = dateIssue;
    ...
    {
        /// <summary>
        /// Инициализация экземпляра <see cref="SubjectInfo"/>
        /// </summary>
        ...
        /// <para>Фамилия, имя и отчество</para>
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Список ФИО субъекта")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute()]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Дата рождения")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "ИНН (при наличии)")]
        ...
        /// <para xml:lang="en">Maximum length: 255.</para>
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "Номер налогоплательщика, присвоенный иностранным государством (при наличии)")]
        ...
        /// </summary>
        [System.ComponentModel.DataAnnotations.Display(Name = "СНИЛС (при наличии)")]
